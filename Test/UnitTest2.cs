...
namespace Test
{
    ...
    public class UnitTest2
    {
        ...
        {
            Assert.AreEqual(0.0, utils.GetValueOfMerchandise(b1));
            Assert.AreEqual(0.0, utils.GetValueOfMerchandise(b2));
        ...
        {
            Assert.AreEqual(20.0, utils.GetValueOfMerchandise(a11));
            Assert.AreEqual(27.5, utils.GetValueOfMerchandise(a12));
            Assert.AreEqual(12.5, utils.GetValueOfMerchandise(a13));
